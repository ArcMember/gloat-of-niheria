...
function serverAuthQrl(authOptions) {
  const useAuthSignin = globalActionQrl(/* @__PURE__ */ inlinedQrl(async ({ providerId, callbackUrl: deprecated, options, authorizationParams }, req) => {
  ...
  const useAuthSignout = globalActionQrl(/* @__PURE__ */ inlinedQrl(async ({ callbackUrl }, req) => {
    const [authOptions2] = useLexicalScope();
  ...
  const useAuthSession = routeLoaderQrl(/* @__PURE__ */ inlinedQrl((req) => {
...
export {
  ...
  defaultCallbackURL as _auto_defaultCallbackURL,
